...
export default function ScheduledTweets({
  ...
  onRefresh,
  onClearSearch,
}: ScheduledTweetsProps) {
  return (
    <>
      {/* Filter Bar */}
      <div className="flex justify-between items-center mb-6">
        <div className="text-sm text-gray-600">
          {tweets.length} scheduled tweet{tweets.length !== 1 ? "s" : ""}
        ...
        {tweets.length > 0 ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              {searchQuery
                ? `No scheduled tweets matching "${searchQuery}"`
                : "You don't have any scheduled tweets yet."}
            </p>
            {searchQuery ? (
              <button
              ...
              <button
                ...
                onClick={() => console.log("Schedule a tweet")}
              >
                Schedule a tweet
              </button>
            )}
